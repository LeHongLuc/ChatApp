...
public class ChatActivity extends BaseActivity {
    ...
    private void init() {
        ...
        chatAdapter = new ChatAdapter(chatMessageList, getBitmapFromEncoded(user.image), preferenceManager.getString(Constants.KEY_USER_ID));
        ...
        ApiService.API_SERVICE.sendMessage(Constants.getRemoteMsgHeader(), messageBody).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()) {
                    ...
                    showToast("Er: " + response.code());
                }
            }

            @Override
            public void onFailure(Call<String> call, Throwable t) {
                showToast("Er1" + t.getMessage());
            }
        });
    }
                ...
                .addSnapshotListener(ChatActivity.this, (value, er) -> {
                    ...
                    if (value != null) {
                        ...
                        if (user.image == null) {
                            ...
                            chatAdapter.setReceiverImage(getBitmapFromEncoded(user.image));
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, er) -> {
        ...
        if (value != null) {
            ...
            if (count == 0) {
                ...
                binding.rvChat.smoothScrollToPosition(chatMessageList.size() - 1);
            }
        }
